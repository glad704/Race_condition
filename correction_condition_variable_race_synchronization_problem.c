/*************************************************************************
 * FILE		: correction_condition_variable_race_synchronisation-problem().c
 * DESCRIPTION	: This is just one way to resolve the sychronization problem
 * 		  demonstrated by this problem. A check is made in sub1 to make
 * 		  sure the pthread_cond_wait() call is not made if the value of
 * 		  count is not what it expects. Its work is also placed after
 * 		  it is awakened, while count is locked.
